	...
	<div class="row">
    	<div class="span3" id="navbar">
        	<ul class="nav nav-list" id="left-nav">
                <li><a href="com_studycompetition_show.php">学术科技类</a></li>			
				<li><a href="com_dancecompetition_show.php">歌唱舞蹈类</a></li>
				<li><a href="com_gymcompetition_show.php">体育竞技类</a></li>
				
            </ul>
        </div>
        
        <div class="span9" id="info">
        	<h3 class="page-header">最新比赛</h3>
<?php
  session_start(); 
   if(!isset($_SESSION['username'])){
		...
		if (!$con)
		 ...
		 if(mysql_select_db("user_db", $con))
		 {
	       ...
	       {
				echo  "<form  action=\"com_competition_info.php\" method=\"get\" >";
