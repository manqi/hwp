    ...
    <div class="row">
        ...
        <div class="span9" id="info">
            ...
            <table width="100%">
                ...
                <tr>
				<td>
				<?php echo "<form   method=\"get\" action=\"competition_info_modify.php\">"; 
				      echo  "<button  name=\"name\" value=$id type=\"submit\" />修改比赛资料</button>";
				      echo "</form>"
				?>
				</td>
				<td>
				<?php echo "<form   method=\"get\" action=\"com_race_user.php\">"; 
				      echo  "<button  name=\"name\" value=$id type=\"submit\" />查看参赛人员</button>";
				      echo "</form>"
				?>
				</td>
