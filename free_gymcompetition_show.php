...
<ul class="nav nav-tabs" id="main-nav">
	<li><a href="free_home.html">首页</a></li>
	<li><a href="free_overview.html">网站概况</a></li>
	<li><a href="free_studycompetition_show.php">最新赛事</a></li>
	...
	<div class="row">
    	<div class="span3" id="navbar">
        	<ul class="nav nav-list" id="left-nav">
                <li><a href="free_studycompetition_show.php">学术科技类</a></li>
				<li><a href="free_dancecompetition_show.php">歌唱舞蹈类</a></li>
                <li><a href="free_gymcompetition_show.php">体育竞技类</a></li>
            </ul>
        </div>
        
        <div class="span9" id="info">
        	<h3 class="page-header">最新赛事</h3>
<?php
  session_start(); 
   if(!isset($_SESSION['username'])){
		...
		if (!$con)
		 ...
		 if(mysql_select_db("user_db", $con))
		 {
	       ...
	       {
				echo  "<form  action=\"free_competition_info.php\" method=\"get\" >";
